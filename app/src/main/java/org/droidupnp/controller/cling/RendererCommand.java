...
public class RendererCommand implements Runnable, IRendererCommand {
    ...
    public RendererCommand(UpnpServiceController controller, ControlPoint controlPoint, RendererState rendererState) {
    ...
    public Service getRenderingControlService() {
        ...
        return ((CDevice) controller.getSelectedRenderer()).getDevice().findService(

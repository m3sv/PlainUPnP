...
class TvActivity : BaseActivity<TvActivityBinding>() {

    override val activityConfig: ActivityConfig = ActivityConfig(R.layout.tv_activity)
...
//    }
//
//    private fun launchLocally(item: MainState.LaunchLocally?) {
//        item?.let {

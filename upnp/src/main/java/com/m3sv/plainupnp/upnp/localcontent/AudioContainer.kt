...
class AudioContainer(
    id: String, parentID: String, title: String, creator: String?, baseURL: String, ctx: Context,
    artist: String?, albumId: String?
) : DynamicContainer(
    id,
    parentID,
    title,
    ...
    override fun getContainers(): List<Container> {
        ...
        val cursor = ctx.contentResolver.query(uri, columns, where, whereVal, orderBy)
